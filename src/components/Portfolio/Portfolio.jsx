...
const Portfolio = ({ data }) => {
  ...
  const getData = (imgLink, title, subTitle, paragraphList, imgTest) => {
    console.log(imgLink, title, subTitle, paragraphList, imgTest);
    let tempData = [imgLink, title, subTitle, paragraphList, imgTest];
