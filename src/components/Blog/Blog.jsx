    ...
    <section id="blog">
      <div className="section blog-section bg-dark">
        <div className="container">
          <SectionHeading title="Achievement & certificate" subTitle="Achievement & certificate" />
          <div className="row gy-4">
            {data.map((element, index) => (
              <div
                className="col-lg-3 col-sm-6"
                key={index}
                onClick={() => getData(element.ImgLink, element.title, element.date, element.paragraphList)}
                data-aos="fade-left"
